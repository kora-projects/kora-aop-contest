...
import ru.tinkoff.benchmark.aop.utils.aot.pcw_spring.Loggable4;

@Aspect
@Component
public class AspectAotPcwLoggable4 {

    @Around(value = "@annotation(loggableAotPcw)", argNames = "joinPoint,loggableAotPcw")
    public Object doAround(ProceedingJoinPoint joinPoint, Loggable4 loggableAotPcw) throws Throwable {
