...
import ru.tinkoff.benchmark.aop.utils.aot.spring.Loggable4;

@Aspect
@Component
public class AspectAotLoggable4 {

    @Around(value = "@annotation(loggableAot)", argNames = "joinPoint,loggableAot")
    public Object doAround(ProceedingJoinPoint joinPoint, Loggable4 loggableAot) throws Throwable {
