...
import ru.tinkoff.benchmark.aop.utils.aot.pcw_spring.Loggable2;

@Aspect
@Component
public class AspectAotPcwLoggable2 {

    @Around(value = "@annotation(loggableAotPcw)", argNames = "joinPoint,loggableAotPcw")
    public Object doAround(ProceedingJoinPoint joinPoint, Loggable2 loggableAotPcw) throws Throwable {
