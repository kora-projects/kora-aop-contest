...
import ru.tinkoff.benchmark.aop.utils.pcw_spring.Loggable4;

@Aspect
@Component
public class AspectLoggable4 {

    @Around(value = "@annotation(loggablePcw)", argNames = "joinPoint,loggablePcw")
    public Object doAround(ProceedingJoinPoint joinPoint, Loggable4 loggablePcw) throws Throwable {
