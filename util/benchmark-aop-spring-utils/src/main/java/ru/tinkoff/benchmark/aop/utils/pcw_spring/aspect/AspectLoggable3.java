...
import ru.tinkoff.benchmark.aop.utils.pcw_spring.Loggable3;

@Aspect
@Component
public class AspectLoggable3 {

    @Around(value = "@annotation(loggablePcw)", argNames = "joinPoint,loggablePcw")
    public Object doAround(ProceedingJoinPoint joinPoint, Loggable3 loggablePcw) throws Throwable {
