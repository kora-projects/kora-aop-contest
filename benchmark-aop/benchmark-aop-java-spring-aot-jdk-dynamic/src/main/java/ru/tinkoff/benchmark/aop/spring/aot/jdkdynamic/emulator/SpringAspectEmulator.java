package ru.tinkoff.benchmark.aop.spring.aot.jdkdynamic.emulator;
...
import ru.tinkoff.benchmark.aop.utils.aot.spring.*;

@Component
public class SpringAspectEmulator implements AspectEmulator {
