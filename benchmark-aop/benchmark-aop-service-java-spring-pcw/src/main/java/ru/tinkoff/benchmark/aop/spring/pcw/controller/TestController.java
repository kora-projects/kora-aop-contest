...
import ru.tinkoff.benchmark.aop.spring.pcw.emulator.SpringAspectEmulator_PCW;
...
public class TestController {
    ...
    private final SpringAspectEmulator_PCW aspectEmulator;

    public TestController(SpringAspectEmulator_PCW aspectEmulator) {
