...
@Component("BeforeNoJoinPointThenAfterReturningNoJoinPoint")
public class SpringAspectjBeforeNoJoinPointThenAfterReturningNoJoinPointEmulator_PCW implements AspectEmulator {
