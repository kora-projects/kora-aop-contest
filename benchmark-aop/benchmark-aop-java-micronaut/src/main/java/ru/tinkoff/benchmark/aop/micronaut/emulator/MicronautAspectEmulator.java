package ru.tinkoff.benchmark.aop.micronaut.emulator;
...
import ru.tinkoff.benchmark.aop.utils.micronaut.*;

@Introspected
@Singleton
public class MicronautAspectEmulator implements AspectEmulator {
