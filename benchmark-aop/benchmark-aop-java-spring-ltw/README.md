...
Load-Time Weaving (LTW) is an aspect weaving mechanism in AspectJ that allows aspects to be dynamically 
applied to classes as they are loaded into the Java Virtual Machine (JVM). 
Unlike compile-time or post-compile weaving, LTW does not require pre-processing of class files — weaving occurs at runtime during class loading.
...
Bench.Spring_Java_Nothing12345_CGLIB_AspectJ_LTW_Around  thrpt   12   2822413,168 ±  99232,363  ops/s
Bench.Spring_Java_Nothing1_CGLIB_AspectJ_LTW_Around      thrpt   12  50932899,869 ± 618267,525  ops/s
```
...
- [Spring Load Time Weaving](https://docs.spring.io/spring-framework/reference/core/beans/context-load-time-weaver.html)
- [Medium Load Time Weaving](https://medium.com/javarevisited/applying-java-aspects-at-load-time-java-instrumentation-api-232b39622b32)
